    ...
    if (data) {
        ...
        data.map((item, index) => {
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-info btn-sm single-product" data-bs-toggle="modal" product_index="${index}" href="#shop_single_modal" ><i class="fas fa-eye"></i ></a>
                    <a class="btn btn-warning btn-sm single-product" data-bs-toggle="modal" product_index="${index}" href="#shop_edit_modal" ><i class="fas fa-edit"></i  ></a>
                    <a class="btn btn-danger btn-sm single-product" href="" ><i class="fas fa-trash"></i  ></a>
                </td>
            </tr>
